...
import SuaDiemThuong from './SuaDiemThuong';
...
export default ({ dataFromParent, parentCallback, parentCallback2 }) => {
    ...
    const [defaultColumnWidths] = useState([
        ...
        { columnName: 'Gia', width: 350 },
        { columnName: 'Diem', width: 350 },
    ]);
    const customStyles = {
        content: {
            top: '50%',
    ...
    const RowDetail = ({ row }) => (
        <SuaDiemThuong rowfromtable={row} parentCallback={callbackFunction} />
    );
            ...
            <Paper>
                <div style={{ width: '100%',  display: 'flex' , backgroundColor:'#B8d8e0'}}>
                    ...
                    <div style={{ width: '40%', textAlign: 'center', alignSelf: 'center', color: '#197420' }}>
                        <b><h2>Bảng Quản lý Chương Trình Khuyến Mãi</h2></b>
                    </div>
                    <div style={{ width: '30%', textAlign: 'right', alignSelf: 'center' }}>
                        <button className='btn-thongke1' onClick={toggleModal} >
                            <b>Add</b>
                        </button>
  ...
  <Dialog
            ...
            >
                <div style={{ width: '100%', marginTop: 10 }}>
                    ...
                    <input className="submit" type="submit" value="Thêm Mốc Đổi Điểm" onClick={Sub}></input>
                </div>
            </Dialog>
        </div>
    );
