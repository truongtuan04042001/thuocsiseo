...
//logo_doitac
import anthien_png from '../images/logo_cac_cty_duoc/anthien.png';
import danapha_png from '../images/logo_cac_cty_duoc/danapha.png';
import DHG_png from '../images/logo_cac_cty_duoc/DHG.png';
import bepharco_png from '../images/logo_cac_cty_duoc/bepharco.png';
import domesco_png from '../images/logo_cac_cty_duoc/domesco.png';
import hetaro_png from '../images/logo_cac_cty_duoc/hetaro.png';
import ymed_png from '../images/logo_cac_cty_duoc/ymed.png';
import mebipha_png from '../images/logo_cac_cty_duoc/mebiphar.png';
import Sanofi_png from '../images/logo_cac_cty_duoc/Sanofi.png';
import sgk_png from '../images/logo_cac_cty_duoc/sgk.png';
import stada_png from '../images/logo_cac_cty_duoc/stada.png';
import DBD_png from '../images/logo_cac_cty_duoc/DBD.png';
import imexpharm_png from '../images/logo_cac_cty_duoc/imewpharm.png';
import LogoOPC_png from '../images/logo_cac_cty_duoc/OPC.png';
import stella_png from '../images/logo_cac_cty_duoc/stella.png';
import vidipha_png from '../images/logo_cac_cty_duoc/vidipha.png';
import Header from './Header';
import Footer from './Footer';
//avatar_khach
import CoLanAnh from '../images/avatar_khach/CoLanAnh.jpg'
import CoHang from '../images/avatar_khach/CoHang.jpg'
import ChiHanh from '../images/avatar_khach/ChiHanh.jpg'
import AnhTruong from '../images/avatar_khach/AnhTruong.jpg'
...
const TrangChu = (props) => {
  ...
  // Mở cái này ra là chịu trách nhiệm đấy . 
  // useEffect(()=>{
  //   fetch(API_URL + '/themmgg2Month', {
  //     method: 'POST',
  //     headers: {
  //       Accept: 'application/json',
  //       'Content-Type': 'application/json'
  ...
  const getProductsAllSale = async (MaNV) => {
    ...
    // await fetch(API_URL + '/slidebanchay', {
    //   method: 'POST',
    //   headers: {
    //     Accept: 'application/json',
    //     'Content-Type': 'application/json'
    ...
    //       setData2(datas.mang)
    //     } else {
    //       getGioHangRedis2(datas.mang, MaNV)
    //       props.capNhatGioHang() // thằng này sẽ gọi header update
    //     }
    //   })
  ...
  //     return item;
  //   });
  //   setData2(newList) // thằng này cập nhật số lượng hiện lên web
  //   const rand = Math.random(2) * 1000
  //   setLamMoiGH(rand)
  // }
  ...
  // const nhapTaySoLuong2 = (maHang, val) => {
  //   const newList = data2.map((item) => {
  //     if (item.MaHang === maHang) {
  //       let sLuong = item.SoLuong
  //       let max = 300
                        ...
                        <div className="section_title_sp_trangchu">
                          <div className='ten_sp_trangchu'>
                            <div className='ten_sp1'>
                              ...
                              }} ><h1 style={{ fontSize: 14 }}>{x.ComboName}</h1></Link>
                            </div>
                          </div>
                          <Link to={{
                            pathname: `/DetailCombo/${x.IdCombo}`,
                    ...
                    <div className='sanpham_trangchu_parent' key={i}>
                      <div className='baongoai_sp4'>
                        <div className='hinh_sp_trangchu'>
                          <Link to={{
                            pathname: `/ChiTietSanPham/${x.MaHang}`,
                            state: {
                              item: x
                            },
                          }} >
                        ...
                        <div className="section_title_sp_trangchu">
                          <div className='ten_sp_trangchu'>
                            <div className='ten_sp1'>
                              ...
                              }} ><h1 style={{ fontSize: 14 }}>{x.TenHang}</h1></Link>
                            </div>
                          </div>
