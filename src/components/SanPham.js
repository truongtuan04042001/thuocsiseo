    ...
    return (
        <div>
            <Helmet>
                ...
                <meta name="description" content="Trang Tổng Hợp Các Sản phẩm Có trong Kho của Thuocsionline.vn ." />
            </Helmet>
            <Header2 MaNVvalue={MaNVvalue} capNhatSLGH={soLuongGioHang} capNhatTTGH={strTogTien} OPModalDN={OPModalDN} callBackApp={DangNhapApp} valueOfModal={openModalDN} />
                ...
                <div className="sanpham123">
                    <div className='a'>
                        <div className='tc_sanpham'>
                            ...
                            {
                                sessionStorage.getItem("Searchfromtc") != null ? <h1>Đang tìm từ khóa :"{sessionStorage.getItem("Searchfromtc")}"</h1> : tagsvalue != null ?
                                    <h1>{tagsvalue}</h1>
                                                ...
                                                <div className='hinh_sp'>
                                                    {
                                                        x.MaHang.indexOf('COMBO_') >= 0 ?
                                                            <Link to={{
                                                                pathname: `/DetailCombo/${x.MaHang}`,
                                                                // state: { item: x },
                                                            }}>
                                                                {x.HinhAnh == null ? <img src={image_default} width='100%' height="100%"></img> : <img src={x.HinhAnh} onError={handleImgError} resizeMode={'cover'} flex='1' width='100%' height="100%" resizeMode='cover' ></img>}
                                                            </Link>
                                                            :
                                                            <Link to={{
                                                    ...
                                                    <div className='ten_sp' style={{ height: 55 }}>
                                                        <div className='ten_sp1'>
                                                            <Link to={{
                                                                ...
                                                                <p className="overfl hoverr" style={{ color: 'black', fontWeight: 'bold', fontSize: 14 }}>{x.TenHang}</p></Link>
                                                        </div>
                                                    </div>
