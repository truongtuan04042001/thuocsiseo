...
import '../css/combouudai.css';
import React from 'react'
// import dungkhuyenmai from '../images/dungkhuyenmai.png'
    ...
    return (
        <div>
            <Helmet>
                ...
                <meta name="description" content="Tổng Hợp các Chương Trình Khuyến Mãi Của Thuocsionline.vn  ." />
            </Helmet>
            <Header2 OPModalDN={OPModalDN} callBackApp={DangNhapApp} valueOfModal={openModalDN} MaNVvalue={MaNVvalue} capNhatSLGH={soLuongGioHang} capNhatTTGH={strTogTien} />
