...
export default ({ dataFromParent, parentCallback, parentCallback2 }) => {
    ...
    const [columns] = useState([
        ...
        { name: 'TenNV', title: 'Tên KH' },
        { name: 'SDT', title: 'SDT' },
        { name: 'Email', title: 'Email' },
        { name: 'MK', title: 'Password' },
        { name: 'DiemThuong', title: 'Điểm TL' },
        { name: 'Cccd', title: 'CCCD' },
        { name: 'DiaChi', title: 'Địa Chỉ' },
        { name: 'PhuongXa', title: 'Phường Xã' },
    ...
    const [defaultColumnWidths] = useState([
        { columnName: 'MaNV', width: 250 },
        { columnName: 'Info', width: 250 },
        { columnName: 'TenNV', width: 250 },
        { columnName: 'SDT', width: 250 },
        { columnName: 'Email', width: 250 },
        { columnName: 'MK', width: 250 },
        { columnName: 'DiemThuong', width: 150 },
        { columnName: 'Cccd', width: 250 },
        { columnName: 'DiaChi', width: 250 },
        { columnName: 'PhuongXa', width: 250 },
    ...
    const RowDetail = ({ row }) => (
        <SuaUser rowfromtable={row} parentCallback={callbackFunction} />
    );
        ...
        <div>
            ...
            <Paper>
                <div style={{ width: '100%',  display: 'flex', backgroundColor:'#B8d8e0' }}>
                    ...
                    <div style={{ width: '40%', textAlign: 'center', alignSelf: 'center', color: '#197420' }}>
                        <b><h2>Bảng Thống Kê Khách Hàng</h2></b>
                    </div>
                    <div style={{ width: '30%', textAlign: 'right', alignSelf: 'center' }}>
                        ...
                        <button className='btn-thongke1' onClick={animports} style={{backgroundColor:'#ff7235'}}>
                            <b>Import</b>
                        </button>
                        {
                            imports ?
            ...
            >
                <div style={{ width: '100%', marginTop: 10 }}>
                    ...
                    <input className="submit" type="submit" value="THÊM KHÁCH HÀNG" onClick={Sub}></input>
                </div>
            </Dialog>
        </div>
    );
