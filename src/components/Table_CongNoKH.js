...
import SuaCongNoKH from './SuaCongNoKH';
...
export default ({ dataFromParent, parentCallback, parentCallback2, tenNV, maNV }) => {
    ...
    const [columns] = useState([
        ...
        { name: 'KhachHang', title: 'Tên Khách Hàng' },
    ...
    const [defaultColumnWidths] = useState([
        { columnName: 'MaKhachHang', width: 150 },
        { columnName: 'SoDienThoai', width: 150 },
        { columnName: 'KhachHang', width: 200 },
        { columnName: 'TenDN', width: 150 },
        { columnName: 'TongCN', width: 200 },
        { columnName: 'DiaChi', width: 500 },
        { columnName: 'NgayXuLy', width: 150 },
        { columnName: 'GhiChu', width: 150 },
        { columnName: 'GhiChuVanChuyen', width: 150 },
    ]);
    ...
    //end hàm cho filter 
    const RowDetail = ({ row }) => (
        <SuaCongNoKH rowfromtable={row} parentCallback={callbackFunction} tenNV={tenNV} />
    );
            ...
            <Paper>
                <div style={{ width: '100%', display: 'flex', position: 'relative', backgroundColor:'#B8d8e0' }}>
                    ...
                    <div style={{ width: '40%', textAlign: 'center', alignSelf: 'center', color: '#197420' }}>
                        <b><h2>Bảng Thống Kê Công Nợ Khách Hàng</h2></b>
                    </div>
