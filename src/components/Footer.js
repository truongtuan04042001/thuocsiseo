  ...
  return (
    <div className="footer" style={{ backgroundColor: '#009900' }}>
      ...
      <div className="ifamefb">
        {/* <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fthuocsionline%2F&tabs=timeline&width=340&height=200&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId" width="340" height="200"></iframe> */}
      </div>
    </div>
  );
}
