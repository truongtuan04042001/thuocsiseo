...
const DatHangNhanh = (props) => {
    ...
    return (
        <div>
            <Helmet>
                <title>Đặt Hàng Nhanh</title>
                <meta name="description" content="Đặt Hàng Nhanh Chóng Với Thuocsionline.vn ." />
            </Helmet>
            <Header2 MaNVvalue={MaNVvalue} capNhatSLGH={soLuongTrongGio} capNhatTTGH={strTogTien} OPModalDN={OPModalDN} callBackApp={DangNhapApp} valueOfModal={openModalDN} />
            {
                hieuUngTaiGioHang ?
